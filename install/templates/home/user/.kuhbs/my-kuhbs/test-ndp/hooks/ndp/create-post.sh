#!/bin/bash
#
# Assign the pci usb card from sys-usb to ndp-test-ndp
...
qvm-pci detach $detach_from $pci_device
...
# Resize volume
qvm-volume resize ndp-test-ndp:private 20G
