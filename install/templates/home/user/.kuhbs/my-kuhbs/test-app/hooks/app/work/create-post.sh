...
qvm-firewall app-test-app-work reset
qvm-firewall app-test-app-work add accept dsthost=matrix.org proto=tcp dstports=443
qvm-firewall app-test-app-work add drop

# Element i3 routing is written once by hooks/app/create-post.sh
echo "running hooks/app/work/create-post.sh"
